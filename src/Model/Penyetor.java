...
public class Penyetor extends User {
    ...
    public void setTotalPoin(double totalPoin) {this.totalPoin = totalPoin;}
    ...
    public void setTotalSetoran(int totalSetoran) {this.totalSetoran = totalSetoran;}
    public ArrayList<Transaksi> getRiwayatTransaksi() {return riwayatTransaksi;}
    public void setRiwayatTransaksi(ArrayList<Transaksi> listTransaksi) {this.riwayatTransaksi = listTransaksi;}
    public void tambahTransaksi(Transaksi id_trx) {riwayatTransaksi.add(id_trx);}
    public String getIdPenyetor() {return idPenyetor;}
    public String getIdBankSampah() {return idBankSampah;}
    public void setIdBankSampah(String idBankSampah) {this.idBankSampah = idBankSampah;}
